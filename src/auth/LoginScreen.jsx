...
import { Info, X, AlertCircle, CheckCircle, Shield, ShieldCheck } from "lucide-react"
  ...
  return (
    <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl transition-all duration-300 hover:shadow-[0_20px_60px_-10px_rgba(107,70,193,0.3)]">
      ...
      <div className="relative bg-gradient-to-r from-violet-600 to-indigo-600 px-8 py-8 text-white">
        ...
        <h1 className="text-center text-3xl font-bold tracking-tight">Iniciar Sesión</h1>
        <p className="mt-2 text-center text-sm font-medium text-white/80">Accede a tu cuenta con Google</p>
      ...
      <div className="px-8 py-8">
        ...
        <div className="mb-8 flex flex-col items-center justify-center space-y-6">
          <div className="flex w-full items-center justify-center">
            ...
            <p className="mx-4 text-sm font-medium text-gray-500">Inicia sesión con</p>
            <div className="h-px flex-1 bg-gray-200"></div>
          </div>
        ...
        <div className="mt-6 overflow-hidden rounded-xl bg-gradient-to-r from-indigo-50 via-purple-50 to-indigo-50 shadow-sm">
          <div className="p-5 relative">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h4 className="text-md font-semibold text-gray-900">Importante:</h4>
                <p className="mt-1 text-sm text-gray-700">
                  Esta encuesta está dirigida exclusivamente a estudiantes con correo institucional{" "}
                  <span className="font-medium text-indigo-700">(@alumnos.udg.mx)</span>.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-violet-600 to-indigo-600 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-semibold text-white">Información Importante</h3>
              </div>
              <button
                onClick={() => setShowInfo(false)}
            ...
            <div className="px-6 py-5">
              <div className="flex items-start mb-5">
                ...
                <div className="ml-3">
                  <h4 className="text-md font-medium text-gray-900">Acceso Exclusivo para Estudiantes</h4>
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-5 border-l-4 border-indigo-500 shadow-inner">
                <p className="text-sm text-gray-700 leading-relaxed">
                  Esta restricción garantiza la <span className="font-medium text-indigo-700">transparencia</span> en
                  las encuestas y evita la participación de bots o cuentas no autorizadas, asegurando que solo los
                  estudiantes de la institución puedan participar.
                </p>
                <div className="mt-3 flex items-center text-sm text-indigo-700">
                  <ShieldCheck className="h-5 w-5 mr-1" />
                  <span className="font-medium">Tu información está segura con nosotros</span>
                </div>
              </div>
